...
#         loss = F.l1_loss(outputT_feat,outputS_feat)####attention transfer
        loss = kd(outputS_feat, outputT_feat)  ### Fitnets
        
#         outputT_feat = [outputT[2],outputT[8]]
#         outputS_feat = [outputS[1],outputS[5]]
...
#             loss = F.l1_loss(outputT_feat,outputS_feat) ###attention_transfer
            loss = kd(outputS_feat, outputT_feat)  ### Fitnets
            '''
            outputT_feat = [outputT[2],outputT[8]]
            outputS_feat = [outputS[1],outputS[5]]
...
def load_model(model,checkpoint_file,istype):
...
def main(args):
    ...
    modelT = load_model(modelT,args.teacher_checkpoint,'teacher')
    print('teacher is loaded')
#     modelS = load_model(modelS,args.student_checkpoint,'student')
