...
from kd_methods import HintLoss,Similarity,PKT,ABLoss, Correlation, FSP, FactorTransfer, VIDLoss
...
#                 # middle layer 
#         outputT_feat = outputT[5]
#         outputS_feat = outputS[3]
...
# #         loss = F.l1_loss(outputT_feat,outputS_feat)  ####attention transfer
#         loss = kd(outputS_feat, outputT_feat)  ###
        
        ################################ For SP,FSP ##########################
#         outputT_feat = [outputT[2],outputT[5],outputT[8]]#,outputT[4][-1]]
#         outputS_feat = [outputS[1],outputS[3],outputS[5]]#,outputS[4][-1]]
        outputT_feat = [outputT[2],outputT[8]]#,outputT[4][-1]]
        outputS_feat = [outputS[1],outputS[5]]#,outputS[4][-1]]
...
# # #         print(f'outputT_feat[0].shape-->3 is {outputT_feat[0].shape}')

#         outputT_feat = [x.unsqueeze(1) for x in outputT_feat]
#         outputS_feat = [x.unsqueeze(1) for x in outputS_feat]

# #         print(f'outputT_feat[0].shape-->4 is {outputT_feat[0].shape}')
#         print(f'length of s_fsp: {s_fsp[0].shape}')        
