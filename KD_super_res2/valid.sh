...
CHECKPOINT=${BASE_PATH}'/experiments/'${DATASET_TYPE}'/sr2/'${MODEL}'_'${MODEL_TYPE}'/best_model.pt'
OUT_DIR=${BASE_PATH}'/experiments/'${DATASET_TYPE}'/sr2/'${MODEL}'_'${MODEL_TYPE}'/results'
