...
from models import DCStudentUNet
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename="log_{}_run_local_{}.txt".format(object_type,model_type),
                            filemode='a',
...
#         break
        print('len of file names',len(train_file_names))
