...
if __name__ == "__main__":
    ...
    object_type = 'cardiac'
    model_type = 'UNet'
    save_path = '/home/hticimg/gayathri/Context-aware-segmentation/KD_seg/{}_{}/models_global'.format(object_type,model_type)
    ...
    writer = SummaryWriter(log_dir='/home/hticimg/gayathri/Context-aware-segmentation/KD_seg/{}_{}/models_global/summary'.format(object_type,model_type))
    ...
    for epoch in tqdm(range(int(epoch_start)+1,int(epoch_start)+1+no_of_epochs)):
        ...
        for i,(inputs,targets) in enumerate(tqdm(trainLoader)):
            ...
            with torch.set_grad_enabled(True):
                ...
                loss = criterion(outputs,targets,gamma=2,alpha=1)
