...
#             loss_imitation = kdl_loss(outputS[-1],outputT[-1])
#             loss_ce = criterion(outputS[-1],targets) 
#             print('losses are in order:',losskd,loss_imitation,loss)
             
#             loss = 10*criterion(outputS[-1],targets) + 0.0001*loss_imitation
#             loss_kd = kd(outputS_feat,outputT_feat)
#             loss = 100000*(loss_kd[0]+loss_kd[1])
...
#             print('losses are in order:',loss_imitation,loss_ce,0.0001*loss_imitation,10*loss_ce,loss)
