...
MODEL_TYPE='kd_fitnets' #student,kd
MASK='cartesian'
...
PREDICTIONS_PATH='/home/hticimg/gayathri/Context-aware-segmentation/KD_seg/exp/'${MODEL}'_'${MODEL_TYPE}'/results'
REPORT_PATH='/home/hticimg/gayathri/Context-aware-segmentation/KD_seg/exp/'${MODEL}'_'${MODEL_TYPE}
