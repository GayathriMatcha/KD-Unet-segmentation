...
MODEL_TYPE='kd_fitnetsSFTN' #student,kd
MASK='cartesian'
...
CHECKPOINT='/home/hticimg/gayathri/Context-aware-segmentation/KD_seg/exp/'${MODEL}'_'${MODEL_TYPE}'/best_model.pt'
OUT_DIR='/home/hticimg/gayathri/Context-aware-segmentation/KD_seg/exp/'${MODEL}'_'${MODEL_TYPE}'/results'
