...
class slicer():
    ...
    def slicer_view(self):
        ...
        return interact(self.vol_slice_view,vol=fixed(self.volume),slice_view=['x','y','z'],
                        slice_no_x=(0,slice_no_x_max,1),slice_no_y=(0,slice_no_y_max,1),
                        slice_no_z=(0,slice_no_z_max,1),fig_size_x=(5,8),fig_size_y=(5,8))
    ...
    def slicer_view_overlay(self):
        ...
        return interact(self.vol_slice_view_overlay,vol1=fixed(self.volume1),vol2=fixed(self.volume2),
                        weight=(0,1,0.1),slice_view=['x','y','z'],slice_no_x =(0,slice_no_x_max,1),
                        slice_no_y=(0,slice_no_y_max,1),slice_no_z=(0,slice_no_z_max,1),fig_size_x=(5,8),fig_size_y=(5,8))
