...
PREDICTIONS_PATH=${BASE_PATH}'/experiments/'${DATASET_TYPE}'/sr3/'${MODEL}'_'${MODEL_TYPE}'/results'
REPORT_PATH=${BASE_PATH}'/experiments/'${DATASET_TYPE}'/sr3/'${MODEL}'_'${MODEL_TYPE}'/'
