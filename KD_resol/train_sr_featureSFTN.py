...
from kd_methods import HintLoss,Similarity,PKT,ABLoss, Correlation, FSP, FactorTransfer, VIDLoss, Attention
...
#                 # middle layer 
        outputT_feat = outputT[8]
        outputS_feat = outputS[2]
...
#         outputT_feat = [outputT[2],outputT[5],outputT[8]]
#         outputS_feat = [outputS[0],outputS[1],outputS[2]]
...
#         loss_group = [F.l1_loss(s, t) for s, t in zip(outputS_feat, outputT_feat)]
