...
#         for mw in model_wts:
# #         print(f'the teacher wts are {tw} and model wts are {mw}')
#             tmp = mw.split('.')
#     #         if tmp[0]!=tcascades:
#             tmp2= tmp[0][:-1] + 's.' + str(int(tmp[0][-1])-1) + '.' + tmp[1] + '.' + tmp[2]
# #             print(f'tmp2 is {tmp2} and {tw}')
...
def main(args):
    ...
    print(f'teacher weights are loaded')
